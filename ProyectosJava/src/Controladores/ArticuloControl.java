...
private Sql mySql = new Sql();
    ...
    public Object[][] getDatoArticulo(Integer Id) {
        String[] columnas = {"codigo", "nombre","tiposdearticulos_id", "empresas_id"};
    ...
    public void CrearArticulo(String Codigo, String Nombre, String Tiposdearticulos_id, String Empresa_id) {
        ...
        mySql.Ejecutar_Insruccion_Sql(datos, "insert into articulos(codigo ,nombre,tiposdearticulos_id,empresas_id) values(?,?,?,?);");
    }
    ...
    public void ActualizarArticulo(String Codigo, String Nombre, String Tiposdearticulos_id, String Empresa_id, String Id) {
        ...
        mySql.Ejecutar_Insruccion_Sql(datos, " update articulos set codigo  = ?,nombre  = ?,tiposdearticulos_id  = ?,empresas_id  = ? where id = ? ;");
    }
